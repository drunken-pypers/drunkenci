(ns drunkenci.handler
  (:require [compojure.core :refer [defroutes routes wrap-routes]]
            [ring.middleware.reload :as reload]
            [drunkenci.routes.home :refer [home-routes]]

            [drunkenci.middleware :as middleware]
            [drunkenci.session :as session]
...
(defn init
  ...
  (timbre/info (str
                 "\n-=[drunkenci started successfully"
...
(defn destroy
  ...
  []
  (timbre/info "drunkenci is shutting down...")
  (stop-nrepl)
